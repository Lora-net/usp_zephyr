...
**Build receiver:**
```bash
west build --pristine --board nucleo_l476rg/stm32l476xx --shield semtech_lr2021mb1xxs samples/usp/sdk/packet_error_rate_lora -- -DCMAKE_C_FLAGS="-DROLE=RECEIVER"
```

**Build transmitter:**
```bash
west build --pristine --board nucleo_l476rg/stm32l476xx --shield semtech_lr2021mb1xxs samples/usp/sdk/packet_error_rate_lora -- -DCMAKE_C_FLAGS="-DROLE=TRANSMITTER"
```
