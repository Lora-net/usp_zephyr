...
### Using overlay / device tree

*Note: This configuration is only relevant if `ENABLE_PERIODIC_UPLINK==ON`*
...
```bash
west build --pristine --board nucleo_l476rg/stm32l476xx --shield semtech_lr2021mb1xxs samples/usp/sdk/ping_pong
```
