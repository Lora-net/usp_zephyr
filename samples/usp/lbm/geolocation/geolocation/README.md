...
`Almanac full update` and `WiFi region detector` Tools are delivered in this software release. The `LR11xx flasher` Tool is **not** delivered (see KNOWN Limitations).

## Compilation

**Build:**
```bash
west build --pristine --board nrf52840dk/nrf52840 --shield semtech_lr1110mb1xxs usp_zephyr/samples/usp/lbm/geolocation/geolocation
```
