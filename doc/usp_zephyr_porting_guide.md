...
In case the targeted MCU requires some modifications, please refer to the [USP Porting Guide - HAL Implementation](https://github.com/Lora-net/usp/blob/v1.2.1-rc18/doc/usp_porting_guide.md).
